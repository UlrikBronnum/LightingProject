...
void main()
{
    vec3 displacement = position.xyz + normal * displacementScale * texture(displacementTexture, texcoord).r;
    fragmentPosition = translationMatrix * vec4(displacement,1.0);
